...
| `blenderart16-material-transparency-smoke` | BlenderArt issue 16 SSS, translucent/transparent materials, smoke and alpha billboards | `issue_open` | `examples/layered_material_scout.py`, `examples/subsurface_scout.py`, `examples/transparency_scout.py`, `examples/soft_atmosphere_scout.py`, `examples/smoke_billboard_scout.py` | #14, #16 | `docs/assets/layered-material-scout.svg`, `docs/assets/subsurface-scout.jpg`, `docs/assets/transparency-scout.jpg`, `docs/assets/smoke-billboard-scout.svg` |
